...
def data_preprocess():
    ...
    train_file_names = [filename for filename in os.listdir(train_dir) if filename.endswith('_1.mat')]
    for filename in train_file_names:
        ...
        voxel_matrix.dump(store_train_dir+filename[:-4])
    """
